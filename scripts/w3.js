document.addEventListener('DOMContentLoaded', () => {
    ...
    // define URLs for Buzz and Fizz images
    ...
    // default values (if not set here it is blank when the page is reloaded, so we set them here) and generate the divs on page load
    inputMin.value = 1;
    inputMax.value = 100;
    createDivs();
});
